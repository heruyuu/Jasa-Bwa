        ...
        <div class="sm:flex sm:mt-16">
            <div class="mt-8 sm:mt-0 sm:w-full flex flex-col md:flex-row justify-between">
                ...
                <div class="flex-1 mt-2 flex-col">
                    ...
                    <div class="my-3">
                        <a href="https://www.instagram.com/heyuu_05/" class="text-serv-text font-light">
                            Instagram
                        </a>
                    </div>
                    <div class="my-3">
                        <a href="https://web.telegram.org/z/" class="text-serv-text font-light">
                            Telegram
                        </a>
                    </div>
                    <div class="my-3">
                        <a href="https://web.facebook.com/muh.pryanto" class="text-serv-text font-light">
                            Facebook
                        </a>
                    </div>
                    <div class="my-3">
                        <a href="https://discord.com/channels/@me" class="text-serv-text font-light">
                            Discord
                        </a>
                    </div>
                </div>
    ...
    <div class="mx-auto lg:px-16 md:px-20 px-8 py-8 ">
        <div class="mt-16 border-t border-serv-border sm:flex justify-between w-100 ">
            ...
            <div class="flex items-right flex-end mt-8">
                <p class="text-serv-text">
                    &copy; 2023 Yuu All rights reserved.
                </p>
            </div>
        </div>
    </div>
